...
const projects = [
  ...
  { id: 1, name: 'Rival Labs Quote Generator', description: 'I created a form where clients can generate a personalised quote that is sent to them via email. I used React and Tailwind with shadcn components. The backend runs on a Lambda function that generates HTML and mails the quote with SES. The form is embedded in their existing WordPress site.', image: rivalLogo },
